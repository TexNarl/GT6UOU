...
import gregtech.worldgen.earth.GTEarthWorldgen;
import gregtech.worldgen.earth.climate.EarthSeasonalSurfaceHandler;
import gregtech.worldgen.earth.preview.EarthPreviewCommand;
...
public final class GT6UOU {
    ...
    public GT6UOU(IEventBus modEventBus, ModContainer modContainer) {
        GTEarthWorldgen.register(modEventBus);
        ...
        NeoForge.EVENT_BUS.addListener(EarthPreviewCommand::onRegisterCommands);
        NeoForge.EVENT_BUS.addListener(EarthSeasonalSurfaceHandler::onLevelTick);
