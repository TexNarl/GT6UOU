...
/**
 * Generates only the solid GT6UOU stone layers in the Overworld compatibility
 * path. Ore veins are coordinated separately by the resource worldgen layer.
 */
public final class StoneLayerWorldgen {
    ...
    public static int generate(WorldGenLevel level, ChunkAccess chunk, BlockPos.MutableBlockPos pos) {
        ...
        // Earth writes its final host rocks directly in EarthNoiseFiller. The
        // replacement scan remains an Overworld-only compatibility path.
